...
class Config:
    ...
    # --- Threat Intelligence (CVE / EPSS) -----------------------------
    # NVD_API_KEY is optional - the NVD API works without a key at a lower
    # rate limit. EPSS (api.first.org) does not require a key at all.
    NVD_API_KEY = os.environ.get("NVD_API_KEY", "")
    EPSS_ENABLED = _bool_env("EPSS_ENABLED", True)
    EPSS_TIMEOUT_SECONDS = int(os.environ.get("EPSS_TIMEOUT_SECONDS", 5))
